...
__all__ = ["set_input", "set_output", "get_noaa_data", "json_to_df", "extract_files", "remove_outliers", "ffill_missing", "sensor_adjustment", "get_energy_by_min",
           "verify_power_energy", "calculate_cop_values" "getLoginInfo", "connectDB", "checkTableExists", "createNewTable", "createUnknownColumns", "loadDatabase"]
